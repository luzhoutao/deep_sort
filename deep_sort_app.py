...
def gather_video_info(video_dir,detection_file):
    ...
    seq_info = {
        "detections": detections,    # detection matrix
        "video": video,   # video reader
        "min_frame_idx": min_frame_idx,  # the first frame id
        "max_frame_idx": max_frame_idx,  # the last frame id
        "feature_dim": feature_dim,  # feature dimension
    }
    return seq_info
